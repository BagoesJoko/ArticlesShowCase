...
@section('content')
  {{-- Content --}}      
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="mt-3 md-2">
        @if(auth()->user()->role == 1 )
          <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modalcreate">Register</button>
        @endif
          @if ($errors->any())
        <div class="my-3">
...
@include('back.user.modal-create')
@include('back.user.modal-delete')
@include('back.user.modal-update')
      </main>
@endsection
