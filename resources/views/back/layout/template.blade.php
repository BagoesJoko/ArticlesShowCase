<html lang="en" data-bs-theme="auto">
   <head>
    ...
    <!-- Custom styles for this template -->
    <link rel="stylesheet" type="text/css" href="{{asset('back/css/dashboard.css')}}">
    {{-- panggil css dinamis --}}
    @stack('css')
  </head>
  <body>
...
{{-- <header class="navbar navbar-light bg-blue sticky-top d-flex-nowrap p-10">
  <a class="navbar-br col-md-3 col-lg-2 me-0 px-3 fs-6 text-black" href="#">Welcome {{ auth()->user()->name}}</a>
  <ul class="navbar-nav flex-row d-md-none">
    <li class="nav-item text-nowrap">
...
<div class="container-fluid mb-3">
  <div class="row">
    ...
    @yield('content')
     ...
     {{-- footer --}}  
     <footer class="sticky-footer bg-white mt-2" stick>
      <div class="container my-auto">
          <div class="copyright text-center my-auto">
              <span>Copyright &copy; Bagus Joko 2024</span>
          </div>
      </div>
     </footer>
     {{-- end footer --}}
   ...
   <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
      ...
      <script src="https://cdn.jsdelivr.net/npm/chart.js@4.3.2/dist/chart.umd.js" integrity="sha384-eI7PSr3L1XLISH8JdDII5YN/njoSsxfbrkCTnJrzXt+ENP5MOVBxD+l6sEG4zoLp" crossorigin="anonymous"></script><script src="{{asset('back/js/dashboard.js')}}"></script>
